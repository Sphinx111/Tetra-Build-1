...
class pi4dqpsk_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frequency_mhz_line_edit.returnPressed.connect(
        	lambda: self.set_frequency_mhz(eng_notation.str_to_num(str(self._frequency_mhz_line_edit.text().toAscii()))))
        ...
        self._freq_offset_khz_line_edit.returnPressed.connect(
        	lambda: self.set_freq_offset_khz(eng_notation.str_to_num(str(self._freq_offset_khz_line_edit.text().toAscii()))))
