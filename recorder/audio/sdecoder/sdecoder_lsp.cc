...
/*
 *
 * LSP codebooks:  split VQ with 3 codebooks. The LSPs are in the cosine domain (-1, 1) in Q15
 *
...
const int16_t sdecoder::ARRAY1_CLSP[LEN_DIC1 * DIM_DIC1] = {
...
const int16_t sdecoder::ARRAY2_CLSP[LEN_DIC2 * DIM_DIC2] = {
    7564 * 2,      -293 * 2,     -2543 * 2,
    7820 * 2,      -150 * 2,     -1813 * 2,
...
const int16_t sdecoder::ARRAY3_CLSP[LEN_DIC3 * DIM_DIC3] = {
...
//static const int nb_qua_ener = 64;

const int16_t sdecoder::T_QUA_ENER[64 * 2] = {
    12,       48,
    69,      287,
    98,      589,
    103,      865,
